 ...
 *
 * @typedef {object} RootZcap
 * @property {string} '@context' - The zcap JSON-LD context URL.
 * @property {string} id - Capability ID (`urn:zcap:root:<encodedTarget>`).
 * @property {string|string[]} controller - The DID(s) authorized to invoke.
 * @property {string} invocationTarget - Resource URI this capability grants
 ...
 *
 * @typedef {object} CapabilityDelegationProof
 * @property {string} type - The cryptographic suite type (e.g.
 *   `'Ed25519Signature2020'`).
 * @property {string} created - ISO 8601 date-time the proof was created.
 * @property {string} verificationMethod - Verification method URI used to sign.
 * @property {'capabilityDelegation'} proofPurpose - Always
 *   `'capabilityDelegation'`.
 * @property {Array<string|DelegatedZcap>} capabilityChain - Ordered capability
 *   chain (root > parent). All entries are string IDs except the last
 *   delegated zcap, which is embedded as an object.
 * @property {string} proofValue - The encoded proof value.
 */
 ...
 *
 * @typedef {object} DelegatedZcap
 * @property {string[]} '@context' - JSON-LD context array; first entry MUST be
 *   the zcap context URL.
 * @property {string} id - Capability ID (absolute URI).
 * @property {string} parentCapability - Parent capability ID (absolute URI).
 * @property {string|string[]} controller - The DID(s) authorized to invoke.
 * @property {string} invocationTarget - Resource URI this capability grants
 *   access to (absolute URI).
 * @property {string|string[]} [allowedAction] - The action(s) the controller
 *   may perform; if absent, no actions are allowed (except for the root zcap).
 * @property {string} expires - ISO 8601 date-time when this capability expires.
 * @property {CapabilityDelegationProof|CapabilityDelegationProof[]} proof -
 ...
 *
 * @typedef {RootZcap|DelegatedZcap} Zcap
 */
